...
// 2026-09-08 기준 ⑥시트 값으로 전면 갱신 (LOSS 이중계상 수정분 + 부대시설 5개 구역 반영).
...
export const SEED_ORDER_ROWS = [
  ...
  // 102동
  { dong: "102동", stone: "보니브라운", gubun: "벽체", ea: 1952, m2: 855.18, m: 1654.63 },
  { dong: "102동", stone: "보니브라운", gubun: "창주위", ea: 422, m2: 73.01, m: 399.29 },
  { dong: "102동", stone: "보니브라운", gubun: "창대", ea: 140, m2: 31.27, m: 129.96 },
  { dong: "102동", stone: "보니브라운", gubun: "P석", ea: 58, m2: 13.6, m: 45.41 },
  { dong: "102동", stone: "스틸그레이", gubun: "벽체", ea: 525, m2: 270.13, m: 509.12 },
  { dong: "102동", stone: "스틸그레이", gubun: "창주위", ea: 39, m2: 7.13, m: 45.92 },
  { dong: "102동", stone: "스틸그레이", gubun: "창대", ea: 10, m2: 2.36, m: 11.58 },
  { dong: "102동", stone: "스틸그레이", gubun: "두겁", ea: 154, m2: 17.54, m: 142.21 },
  // 102동 호이스트
  { dong: "102동 호이스트", stone: "보니브라운", gubun: "벽체", ea: 216, m2: 114.81, m: 216.34 },
  { dong: "102동 호이스트", stone: "보니브라운", gubun: "창주위", ea: 78, m2: 13.54, m: 74.02 },
  { dong: "102동 호이스트", stone: "보니브라운", gubun: "창대", ea: 30, m2: 7.05, m: 29.39 },
  { dong: "102동 호이스트", stone: "스틸그레이", gubun: "두겁", ea: 18, m2: 2.19, m: 17.78 },
  // 게스트하우스
  ...
  // 113동
  { dong: "113동", stone: "보니브라운", gubun: "벽체", ea: 2757, m2: 1282.18, m: 2429.21 },
  ...
  { dong: "103동", stone: "스틸그레이", gubun: "벽체", ea: 622, m2: 330.51, m: 613.74 },
  ...
  // 104동(추가)
  { dong: "104동(추가)", stone: "보니브라운", gubun: "벽체", ea: 90, m2: 28, m: 76.71 },
  // 104동(1차)
  ...
  { dong: "104동(1차)", stone: "스틸그레이", gubun: "창주위", ea: 46, m2: 8.14, m: 55 },
  ...
  { dong: "111동", stone: "보니브라운", gubun: "창대", ea: 109, m2: 25.04, m: 104.91 },
  ...
  { dong: "111동", stone: "스틸그레이", gubun: "두겁", ea: 120, m2: 16.05, m: 111.46 },
  // 근생2
  { dong: "근생2", stone: "스틸그레이", gubun: "벽체", ea: 160, m2: 64.24, m: 154.259 },
  { dong: "근생2", stone: "스틸그레이", gubun: "두겁석", ea: 88, m2: 51.33, m: 102.65 },
  { dong: "근생2", stone: "스틸그레이", gubun: "창주위", ea: 6, m2: 0.88, m: 4.18 },
  { dong: "근생2", stone: "스틸그레이", gubun: "창대", ea: 65, m2: 27.84, m: 87.44 },
  { dong: "근생2", stone: "포천석", gubun: "벽체", ea: 649, m2: 312.037, m: 649.762 },
  { dong: "근생2", stone: "포천석", gubun: "두겁석", ea: 53, m2: 30.02, m: 56.02 },
  { dong: "근생2", stone: "포천석", gubun: "창주위", ea: 20, m2: 4.32, m: 20.2 },
  { dong: "근생2", stone: "포천석", gubun: "창대", ea: 4, m2: 1.08, m: 4.01 },
  // 게스트하우스·주공1
  { dong: "게스트하우스·주공1", stone: "스틸그레이", gubun: "벽체", ea: 386, m2: 191.732, m: 432.721 },
  { dong: "게스트하우스·주공1", stone: "스틸그레이", gubun: "두겁", ea: 47, m2: 24.465, m: 53.82 },
  { dong: "게스트하우스·주공1", stone: "포천석", gubun: "벽체", ea: 815, m2: 405.639, m: 869.047 },
  { dong: "게스트하우스·주공1", stone: "포천석", gubun: "두겁", ea: 135, m2: 101.613, m: 154.87 },
  // 창마감 추가(전구역)
  { dong: "창마감 추가(전구역)", stone: "보니브라운", gubun: "창주위", ea: 50, m2: 13.32, m: 60 },
  { dong: "창마감 추가(전구역)", stone: "보니브라운", gubun: "창대", ea: 40, m2: 13.44, m: 48 },
  { dong: "창마감 추가(전구역)", stone: "스틸그레이", gubun: "창주위", ea: 40, m2: 10.56, m: 48 },
  { dong: "창마감 추가(전구역)", stone: "스틸그레이", gubun: "창대", ea: 10, m2: 3.48, m: 12 },
  // 문주·경비실
  { dong: "문주·경비실", stone: "블랑코머핀", gubun: "벽체", ea: 227, m2: 103.79, m: 207.85 },
  { dong: "문주·경비실", stone: "스틸그레이", gubun: "벽체", ea: 86, m2: 43.906, m: 86.34 },
  // 어린이집·돌봄센터
  { dong: "어린이집·돌봄센터", stone: "스틸그레이", gubun: "벽체", ea: 82, m2: 21.607, m: 57.046 },
  { dong: "어린이집·돌봄센터", stone: "스틸그레이", gubun: "두겁", ea: 26, m2: 11.112, m: 27.78 },
  { dong: "어린이집·돌봄센터", stone: "포천석", gubun: "벽체", ea: 781, m2: 409.279, m: 774.329 },
  { dong: "어린이집·돌봄센터", stone: "포천석", gubun: "두겁", ea: 175, m2: 100.497, m: 185.731 },
];

// ①기준정보 "▶ 부대시설 계획 수량" 블록 시드 — 동기화하면 엑셀 값으로 대체됩니다.
// 수량은 ⑥석재발주_시트별의 구역별 합계와 동일. 착공·완료예정일은 엑셀에서 직접 입력하는 값이라
// 아직 정해지지 않은 구역은 빈 값으로 둡니다.
export const BUILDINGS_FACILITY = [
  { dong: "근생2", totalArea: 491.739, startDate: "2026-09-02", endDate: "", workDays: 0, dailyPlan: 0, baseWorkers: 0, hoist: 0, note: "발주 2026-07-31 (1,045EA)" },
  { dong: "게스트하우스·주공1", totalArea: 723.449, startDate: "", endDate: "", workDays: 0, dailyPlan: 0, baseWorkers: 0, hoist: 0, note: "발주 2026-08-25 (1,383EA)" },
  { dong: "문주·경비실", totalArea: 147.696, startDate: "", endDate: "", workDays: 0, dailyPlan: 0, baseWorkers: 0, hoist: 0, note: "발주 2026-08-31 (313EA)" },
  { dong: "어린이집·돌봄센터", totalArea: 542.495, startDate: "", endDate: "", workDays: 0, dailyPlan: 0, baseWorkers: 0, hoist: 0, note: "발주 2026-09-01 (1,064EA)" },
  { dong: "게스트하우스(썬큰)", totalArea: 204.6, startDate: "2026-07-10", endDate: "", workDays: 0, dailyPlan: 0, baseWorkers: 0, hoist: 0, note: "발주 2026-05-29 (557EA) · 썬큰 시공분" },
];
